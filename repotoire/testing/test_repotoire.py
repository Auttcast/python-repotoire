...
def test_sqlite_repotoire_create():
    ...
    repo.my_entity.add(TestEntity(name="test1", data_int=123, data_float=1.1, data_datetime=datetime(2025, 1, 1)))
    repo.my_entity.add(TestEntity(name="test2", data_int=456, data_float=1.02, data_datetime=datetime(2025, 1, 2)))
    ...
    assert native_result[0][4] == datetime(2025, 1, 1) #data_datetime
